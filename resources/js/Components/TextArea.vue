<template>
    <label class="flex flex-col gap-1 text-black">
        ...
        <textarea
            ...
            :value="modelValue"
            :class="leading"
            class="w-full rounded-md border border-gray-200 text-sm text-black placeholder:text-xs placeholder:text-gray-400 focus:border-none focus:ring-1 focus:ring-brand-300 lg:text-xs"
