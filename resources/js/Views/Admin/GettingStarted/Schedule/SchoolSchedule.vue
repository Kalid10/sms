<template>
    <Modal v-model:view="showCreateModal">
        <FormElement
            ...
            @cancel="clear">
            <TextInput
v-model="schoolScheduleFormData.title" :error="schoolScheduleFormData.errors.title" label="Name"
                       placeholder=" name" :required="true"/>
            <TextArea
v-model="schoolScheduleFormData.body" :error="schoolScheduleFormData.errors.body"
                      label="Description" placeholder="Its about..." :required="true"/>
            <TextInput v-model="inputTags" label="tags" placeholder="tag1,tag2,tag3" :required="true"/>
            <DatePicker
v-model:start-date="schoolScheduleFormData.start_date"
                        v-model:end-date="schoolScheduleFormData.end_date" range label="Date" required></DatePicker>
            <RadioGroupPanel
v-model="schoolScheduleFormData.type" label="Type" :options="eventTypes"
                             name="event-types"/>
        </FormElement>
    </Modal>
</template>
