<template>
    ...
    <Card :title="`Personal details`" class="!max-w-full !grow">
        ...
        <div class="flex h-full justify-between gap-3">
            ...
            <div class="flex aspect-square h-full items-center justify-center whitespace-nowrap rounded-full bg-gray-200 text-3xl font-semibold">
