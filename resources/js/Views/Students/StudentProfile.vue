    ...
    <div class="flex flex-col items-center gap-5">
        ...
        <div class="flex w-full flex-col gap-3">
            ...
            <div class="mx-auto flex w-fit flex-col items-center">
                <Heading class="text-center !font-semibold" size="lg">{{ student.user.name }}</Heading>
                <h3 class="text-sm font-semibold text-gray-500">{{ section['level']['level_category']['name'] }}</h3>
            </div>
