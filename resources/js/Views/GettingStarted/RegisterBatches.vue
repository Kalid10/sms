<template>
    <div class="flex flex-col">
        ...
        <h3 class="text-sm text-gray-500">
            We have selected a set of default batches for you. You can remove
            batches you don't need, add new batches or edit the number of
            sections in each batch.
    ...
    >
        ...
        <button
            class="flex min-h-[106px] flex-col items-center justify-center gap-2 rounded-md border-2 border-dashed bg-white/75"
            @click="openNewLevelForm"
        >
            <PlusCircleIcon class="h-5 w-5 stroke-gray-500 stroke-2" />
            <span class="text-sm font-semibold text-gray-500"
                >Create a new Level</span
            >
        </button>
