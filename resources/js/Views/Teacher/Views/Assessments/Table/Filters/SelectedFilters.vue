<template>
    ...
    >
        ...
        <FilterItem
            ...
            :value="selectedAssessmentTypeName"
            @remove="$emit('removeAssessmentType')"
        />
        <FilterItem
        ...
        <PlusIcon
            v-if="!showFilter"
            class="hover:w-4.5 w-4 cursor-pointer hover:text-black"
            @click="$emit('show')"
        />
    </div>
</template>
<script setup>
import FilterItem from "@/Views/Teacher/Views/Assessments/Table/Filters/FilterItem.vue";
...
const props = defineProps({
    ...
    selectedAssessmentTypeName: {
        type: String,
        default: null,
    },
    selectedBatchSubjectName: {
        type: String,
        default: null,
    },
    selectedSchoolYear: {
