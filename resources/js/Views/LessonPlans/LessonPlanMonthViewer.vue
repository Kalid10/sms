<template>
    ...
    <div class="flex h-full w-full gap-4 bg-white px-8 pt-4">
        ...
        <LessonPlanWeekCard v-for="w in weeksInMonth" :key="w" :batch-sessions="batchSessions[`week${w}`]" :index="w">
...
import LessonPlanWeekCard from "@/Views/LessonPlans/LessonPlanWeekCard.vue";
import LessonPlanCard from "@/Views/LessonPlans/LessonPlanCard.vue";
