<template>
    ...
    <Modal v-model:view="openForm" background-color="transparent">
        ...
        <div class="fixed top-0 left-0 grid h-screen w-full grid-cols-2">
            ...
            <div
                class="relative z-10 col-span-1 col-start-2 h-full w-full animate-slide-left border-l bg-white pl-8 pt-8 shadow-sm">
                ...
                <div class="flex h-full w-full flex-col gap-4">
                        ...
                        <div class="flex w-full origin-left items-center justify-between pr-8">
                            ...
                            <div class="flex items-center gap-12">
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        class="grid h-5 w-5 place-items-center rounded-full border border-brand-100 bg-brand-50 text-xs font-semibold leading-none text-brand-100">
                    ...
                    <div class="grid w-full grow grid-cols-12 gap-8">
                        ...
                        <div class="col-span-7 flex h-full flex-col gap-8 pt-4">
                            ...
                            <form
v-if="updateLessonPlan || !!! selectedBatchSession['lesson_plan_id']"
                                ...
                                <div v-if="!!! selectedBatchSession['lesson_plan_id']" class="flex flex-col">
                                    ...
                                    <h3 class="text-sm text-gray-500">Add the topic and description of the lesson plan
                                        for the session here</h3>
                                </div>

                                <TextInput
v-model="form.topic" required label="Topic"
                                           placeholder="Topic of the Lesson Plan"/>

                                <TextArea
v-model="form.description" label="Description" rows="20"
                                          leading="leading-loose" placeholder="Add your Lesson Plan description"/>
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex w-full items-end justify-between">
                                        <h3 class="font-semibold">{{
                                                selectedBatchSession['lesson_plan']['topic']
                                            }}</h3>
                                        <TertiaryButton class="shadow-sm" @click="updateLessonPlan = true">Edit
                                        </TertiaryButton>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-6">
                                    ...
                                    <div class="grid h-36 w-full place-items-center">
                                        ...
                                        <div class="flex w-full flex-col items-center justify-center gap-1">
                                            ...
                                            <h3 class="max-w-[18rem] text-center text-xs text-gray-500">
                                                Previous lesson plans have not been added for this session. Make sure
                                                you have
                                ...
                                <template v-else>
                                    ...
                                    <div
v-for="(prevBatchSession, pBS) in previousBatchSessionsWithLessonPlans"
                                         :key="pBS"
                                         class="scrollbar-hide flex h-fit flex-col overflow-hidden overflow-y-scroll">

                                        <h3 class="text-sm font-normal">{{
                                                prevBatchSession['lesson_plan']['topic']
                                            }}</h3>
                                        <h3 class=" text-sm text-gray-400">
                                            <ReadMoreLess
lines="4"
                                                          :text="prevBatchSession['lesson_plan']['description']"/>
                                            ...
                                            <span
                                                ...
                                                {{ dayLabel(prevBatchSession['batch_schedule']['day_of_week']) }}
                                                    ...
                                                    <h3 class="font-semibold text-gray-500">
                                                        {{ moment(prevBatchSession.date).format('MMMM Do') }}</h3>
                                                </div>
                                                ...
                                                <div class="flex origin-right scale-90 items-center gap-1.5">
                                                    <div class="flex gap-1">
                                                        ...
                                                        <div class="flex items-end gap-1.5">
                                                            <span
                                                                class="text-sm font-semibold text-gray-500">Period</span>
                                                            <div class="flex origin-left scale-95 items-center gap-1">
                                                        <span
                                                            class="grid h-5 w-5 place-items-center rounded-full border border-brand-100 bg-brand-50 text-xs font-semibold leading-none text-brand-100">
                                                            {{
