    ...
    <div class="grid h-full lg:grid-cols-2">
                ...
                <fieldset class="flex flex-col gap-6">
                    <div class="flex flex-col gap-3">
                        <TextInput
                            ...
                            class="w-full"
                            :label="$t('signUp.emailOrPhoneLabel')"
                        ...
                        <TextInput
                            ...
                            class="w-full"
                            :label="$t('signUp.currentPasswordLabel')"
                            placeholder="**********"
                            required
                            :subtext="$t('signUp.currentPasswordSubtext')"
                            type="password"
                        />
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <TextInput
                            ...
                            class="w-full"
                            :subtext="$t('signUp.confirmPassword')"
                            placeholder="**********"
                            required
                            type="password"
                        />
        ...
        >
            ...
            <h3 class="max-w-xl font-medium text-white">
                Unlock your school's potential with our comprehensive management
                solution. Streamline processes, enhance communication, and
                foster a collaborative learning environment for a brighter
                tomorrow.
            </h3>
        </div>
    </div>
