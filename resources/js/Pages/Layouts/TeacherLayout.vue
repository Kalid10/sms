<template>
    ...
    <div class="relative flex h-screen w-full flex-col">
        <div
            class="hide-scrollbar w-full grow overflow-y-auto bg-white p-0"
        >
            <div class="flex w-full">
                ...
                />
                <div
                    :class="openSideBar ? 'min-w-full lg:min-w-0 blur lg:blur-0' : ''"
...
import {
    ...
    ClipboardIcon, Cog6ToothIcon, PowerIcon,
    UserIcon
