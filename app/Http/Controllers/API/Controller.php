...
class Controller extends \Illuminate\Routing\Controller
{
    ...
    public function update(UpdateRequest $request, ?Student $student): Resource|\App\Http\Resources\Guardians\Guardian\Resource|\App\Http\Resources\Teachers\Resource
    {
        ...
        try {
            ...
            if ($student->exists) {
                ...
                return new \App\Http\Resources\Teachers\Resource($user->load('address'));
            }
